    ...
    17: function (e, t, n) {
      ...
      a()(function () {
        ...
        var e = a()('body'),
          ...
          E = function (e, t) {
            var n = new GhostContentAPI({ url: e, key: t, version: 'v4' }),
              o = [],
              a = {
                shouldSort: !0,
                ignoreLocation: !0,
        ...
        if (
          ...
          var P2 = document.getElementById('2secondary-navigation-template');
          L = Object(l.a)('.js-open-secondary-menu2', {
            appendTo: document.body,
            content: P2.innerHTML,
            allowHTML: !0,
            arrow: !0,
            trigger: 'click',
            interactive: !0,
